   ...
   async run(msg, [command]) {
      if (command) {
         let embed = new MessageEmbed()
            ...
            .addField(msg.language.get(`COMMAND_USAGE`), command.usage.fullUsage(msg))
            .addField(
            ...
            .addField(`NSFW`, command.nsfw ? msg.language.get('COMMAND_HELP_YES') : msg.language.get('COMMAND_HELP_NO'))
            .addField(
