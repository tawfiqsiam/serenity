...
module.exports = class extends Command {
  ...
  async run(msg, [user]) {
    const userlogs = msg.guild.settings.get('data.modlogs').filter(log => log.user.id === user.id).reverse();
  ...
  async buildDisplay(msg, user, userlogs) {
    ...
    display.emojis = {
      first: `695732751722348666`,
      last: `695732759527817297`,
      back: `695693140878819509`,
      forward: `695693142103687208`,
      jump: `695688887779196990`,
      stop: `695693894909952020`
    }
