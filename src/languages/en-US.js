...
module.exports = class extends Language {
   constructor(...args) {
      ...
      this.language = {
         ...
         COMMAND_HELP_DM: `${success} The list of commands you have access to has been sent to your DMs.`,
         COMMAND_HELP_NODM: `${error} You have DMs disabled, I couldn't send you the commands in DMs.`,
         ...
         COMMAND_AVATAR_DESCRIPTION: 'Displays the users avatar.',
         COMMAND_AVATAR_PLURAL: (tag) => `${tag}'s avatar`,
         COMMAND_REMINDME_DESCRIPTION: 'Make the bot remind you of something at a certain time.',
         COMMAND_REMINDME_TOO_LONG: `${error} You can't set a reminder for over 3 months.`,
         COMMAND_REMINDME_SUCCESS: `${success} Created reminder.`,
         COMMAND_ROLEINFO_DESCRIPTION: 'Displays information about a role.',
         COMMAND_RPS_DESCRIPTION: 'Play rock paper scissors with the bot.',
         COMMAND_RPS_INVALID: 'Invalid option. Options: `rock`, `paper` or `scissors`.',
